...
--awful.util.tagnames = {  " ", " ", " ", " ", " ", " ", " ", " ", " ", " "  }
awful.util.tagnames = { " ONE ", " TWO ", " THREE ", " FOUR ", " FIVE ", " SIX ", " SEVEN ", " EIGHT ", " NINE " }
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "g", function () awful.util.spawn( "steam" ) end,
        {description = "steam games client" , group = "gui apps" }),
    awful.key({ modkey }, "d", function () awful.util.spawn( "discord" ) end,
        {description = "discord chat client" , group = "gui apps" }),
    awful.key({ modkey }, "y", function () awful.util.spawn( "spotify" ) end,
        {description = "start spotify" , group = "gui apps" }),
    -- Hotkeys Awesome
